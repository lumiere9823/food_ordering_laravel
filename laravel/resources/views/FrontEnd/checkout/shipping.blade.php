		...
		<div class="container"> 
			...
			<div class="login-agileinfo"> 
				<form action="{{ route('store_shipping') }}" method="post"> 
					@csrf
					<input class="agile-ltext" type="text" name="name" placeholder="Username" value="{{$customer->name}}" required="">
					<input class="agile-ltext" type="email" name="email" placeholder="Your Email" value="{{$customer->email}}" required="">
					<input class="agile-ltext" type="text" name="phone" placeholder="Your Phone Number" value="{{$customer->phone}}" required="">
