                    ...
                    <div style="display: flex; justify-content: space-between;align-item: center;">
                        ...
                        <div class="grand-total" id="final" style="margin-top: 20px; text-align: right;">
                            ...
                            <select name="coupon" id="coupon">
                                ...
                                @if($coupon->cart_min_value <= $i) <option value="{{ $coupon->coupon_number }}"
            ...
            <div class="modal-body"
                ...
                <div class="col-md-6" style="margin-right: 20px; position: relative;">
                    <div style="width: 100%; height: 0; padding-bottom: 100%; position: relative;">
                        <img
                            src="https://t3.ftcdn.net/jpg/06/76/45/32/240_F_676453298_oawytYg5O4uT2TDkORl8t5rbGuuwGqf9.jpg"
                            alt=""
...
<script>
    ...
    document.getElementById('coupon').addEventListener('change', function() {
        var couponValue = parseInt(this.options[this.selectedIndex].getAttribute('data-coupon-value'));
var totalAmount = parseInt({{ $i }});
...
<?php
if (isset($_GET['couponValue'])) {
    $couponValue = $_GET['couponValue'];
} else {
    $couponValue = 0;
}
$totalAmount = $i; // Lấy giá trị từ JavaScript
$discountedAmount = $totalAmount - ($totalAmount * $couponValue / 100);
$i = $discountedAmount;
Session::put('sum', $i);
?>
