            ...
            <div class="row justify-content-center">
                        ...
                        <div class="mb-3">
                            <div class="card"
                                ...
                                <div class="card-header"
                                    style="display: flex;justify-content: space-between; padding-top: 4px;">
                                    <h5>Order #{{ $index + 1 }}</h5>
                                    <form method="POST" action="{{ route('accepted_order', $order->order_id) }}">
                                        @csrf
                                        @method('PUT')
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content" style="border-radius: 16px;">
                                    <div class="modal-header"
                                        ...
                                        <h5 class="modal-title" id="orderDetailModalLabel{{ $order->order_id }}">Order
                                            Detail
                                        </h5>
                                                ...
                                                <div style="padding: 10px;">
                                                    ...
                                                    <div style="margin-bottom: 10px;">
                                                        ...
                                                        <input type="text" class="form-control" id="Price"
                                                            name="Price" value="{{ $order_detail->dish_price ?? '' }}"
                                                            style="width: 100%;" readonly>
                                                    </div>
                                                    <div style="margin-bottom: 10px;">
                ...
                @else
                    <div class="alert alert-warning" role="alert">
                        <strong>There is no order to display!</strong>
                @endif
            </div>
        </section>
    </div>
